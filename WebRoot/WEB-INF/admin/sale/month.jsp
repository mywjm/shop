                  ...
                  <div class="tile-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        ...
                        <h5><strong>月度</strong> 总销售表(单位千元)</h5>
                      ...
                      <div class="col-md-12">
                        ...
                        <h5><strong>月度</strong> 平均销售表(单位千元)</h5>
                        <span id="sparkline02" data-values="8,5,7,7,5,6,9,6,4,8,6,3" data-type="bar" data-height="250px"></span>
...
<script src="assets/js/jquery.js"></script>
    ...
    $(function(){
      ...
      $('#sparkline01').sparkline([18,14,17,19,21,15,26,24,23,22,20,18], {
        type: 'line', 
        width: '100%',
        height:'250px',

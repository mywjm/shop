        ...
        <div id="content" class="col-md-12">
		 ...
		 <div class="breadcrumbs">
          ...
          <div class="main">
    	   ...
    	   <!-- 管理员添加 -->
    	  <div >
		<form class="form-horizontal" action="${pageContext.request.contextPath }/AdminCategory_add.action" method="post" onsubmit="return check()">
	
		  <div class="form-group">
		    <label for="cname" class="col-sm-2 control-label">一级菜单名</label>
		    <div class="col-sm-10">
		      <input type="text" name="cname" value="" class="form-control" id="cname" placeholder="cname">
		    </div>
		  </div>

...
<html>
  <head>
    ...
    <title> <s:property value="#request.keyWord" /></title>
    ...
    <!-- Page content -->
        <div id="content" class="col-md-12">
         ...
         <!-- page header -->
          <div class="pageheader">
            ...
            <h2><i class="fa fa-tachometer"></i> 商品管理
            <span><s:actionmessage/></span></h2>
             ...
             <div class="breadcrumbs">
              <ol class="breadcrumb">
                ...
                <li class="active">搜索<s:property value="#request.keyWord" /></li>
              </ol>
            </div>
		...
		<table class="table table-bordered table-hover " style="text-align: center;">
			<tr >
				...
				<th style="text-align: center;">商品上架时间</th>
				<th style="text-align: center;">商品所属分类</th>
			...
			<tr>
				...
				<td ><a target="_blank" href="${pageContext.request.contextPath }/<s:property value="#p.image" />"><img src="<s:property value="#p.image" />" alt="<s:property value="#p.pname" />" style = "width: 100px; height: 100px;" /></a></td>
				<td style="overflow: auto;"><s:property value="#p.pname"/></td>
			
				<td>￥<s:property value="#p.shop_price"/>元</td>
				<td>
					<s:if test="#p.is_hot == 1">
						是
					</s:if>
					<s:if test="#p.is_hot == 0">
						否
					</s:if>
				</td>
				<td><s:property value="#p.pdate"/></td>
				<td><s:property value="#p.categoryThird.ctname"/></td>
				<td style="overflow: auto;"><s:property value="#p.pdesc"/></td>
				<td>
				<s:if test="#session.existAdminUser != null">
				<a href="#" onclick="onclickB()">删除</a>
				</s:if>
				<s:else>
				<a href="#" onclick="deleteA()">删除</a>
				</s:else>
				</td>
				<td>
				<s:if test="#session.existAdminUser != null">
				<a href="${ pageContext.request.contextPath }/AdminProduct_edit.action?pid=<s:property value="#p.pid" />" onclick="onclickA()">修改</a>
				</s:if>
				<s:else>
				<a href="#" onclick="deleteA()">修改</a>
				</s:else>
				</td>
                    ...
                    <div class="product-pagination text-center">
                        <nav>
                          <ul class="pagination  pagination-lg">
                            <li>
                              <a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=1" aria-label="first">
                                <span aria-hidden="true">&laquo;</span>
                              </a>
                            </li>
                            <s:if test="#request.pageBean.page>1">
                            <li>
                              <a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page-1" />" aria-label="Previous">
                            ...
                            <li>
                             ...
                             <s:if test="#request.pageBean.totalPage >= 5">
                             	<s:if test="#request.pageBean.page >2 " >
	                           	 <li><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page-2" />"><s:property value="#request.pageBean.page-2" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page-1" />"><s:property value="#request.pageBean.page-1" /></a></li>
	                           	 <li class="active"><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page" />" ><s:property value="#request.pageBean.page" /></a></li>
	                           	 <s:if test="#request.pageBean.page < #request.pageBean.totalPage-1">
	                           	 <li><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page+1" />"><s:property value="#request.pageBean.page+1" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page+2" />"><s:property value="#request.pageBean.page+2" /></a></li>
	                           	 </s:if>
                           	 	</s:if>
                           	 	<s:if test="#request.pageBean.page==1 " >
                           	 	 <li class="active"><a href="#" ><s:property value="#request.pageBean.page" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page+1" />"><s:property value="#request.pageBean.page+1" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page+2" />"><s:property value="#request.pageBean.page+2" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page+3" />"><s:property value="#request.pageBean.page+3" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page+4" />"><s:property value="#request.pageBean.page+4" /></a></li>
                           	 	</s:if>
                           	 	<s:if test="#request.pageBean.page==2" >
                           	 	 <li><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page-1" />"><s:property value="#request.pageBean.page-1" /></a></li>
                           	 	 <li class="active"><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.#request.pageBean.page" />" ><s:property value="#request.pageBean.page" /></a></li>
                           	 	 <li><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page+1" />"><s:property value="#request.pageBean.page+1" /></a></li>
                           	 	 <li><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page+2" />"><s:property value="#request.pageBean.page+2" /></a></li>
                           	 	 <li><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page+3" />"><s:property value="#request.pageBean.page+3" /></a></li>
                           	 	</s:if>
                              	...
                              	<!-- totalPage小于5 -->
                              <s:if test="#request.pageBean.totalPage == 4">
                              		<li class="active"><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page" />" ><s:property value="#request.pageBean.page" /></a></li>
                              	</s:if>
                              	<s:if test="#request.pageBean.totalPage == 3">
	                           		 <li class="active"><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page" />" ><s:property value="#request.pageBean.page" /></a></li>
                              	</s:if>
                              	<s:if test="#request.pageBean.totalPage == 2">
	                           		 <li class="active"><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page" />" ><s:property value="#request.pageBean.page" /></a></li>
                              	</s:if>
                              	<s:if test="#request.pageBean.totalPage == 1">
	                           		 <li class="active"><a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page" />" ><s:property value="#request.pageBean.page" /></a></li>
                            ...
                            <li>
                              <a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.page+1" />" aria-label="Next">
                            ...
                            <li>
                              <a href="${pageContext.request.contextPath}/AdminProduct_SearchWord.action?keyWord=<s:property value="#request.keyWord" />&page=<s:property value="#request.pageBean.totalPage" />" aria-label="last">
                                <span aria-hidden="true">&raquo;</span>
                              </a>
                            </li>
                            <li > <a style="margin: 0 20px;">共<s:property value="#request.pageBean.totalPage" />页   </a> </li>
                          </ul>
                        </nav>   

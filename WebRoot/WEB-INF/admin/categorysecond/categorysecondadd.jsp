        ...
        <div id="content" class="col-md-12">
         ...
         <!-- page header -->
          ...
          <div class="main">
    	   ...
    	   <!-- 管理员添加 -->
    	  <div >
		<form class="form-horizontal" action="${pageContext.request.contextPath }/AdminCS_add.action" method="post" onsubmit="return check()">
	
		  <div class="form-group">
		    <label for="csname" class="col-sm-2 control-label">二级菜单名</label>
		    <div class="col-sm-10">
		      <input type="text" name="csname" value="" class="form-control" id="csname" placeholder="csname">
		    </div>
		  </div>
		 <div class="form-group">

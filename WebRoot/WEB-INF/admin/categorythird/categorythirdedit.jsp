        ...
        <div id="content" class="col-md-12">
         ...
         <!-- page header -->
          ...
          <div class="main">
    	   ...
    	   <!-- 三级菜单添加 -->
    	  <div >
		<form class="form-horizontal" action="${pageContext.request.contextPath }/AdminCT_update.action" method="post" onsubmit="return check()">
		<%--  <input type="hidden" name="ctid" value="<s:property value="ct.ctid" />" />  --%>
		  <div class="form-group">
		    <label for="ctid" class="col-sm-2 control-label">ID</label>
		    <div class="col-sm-10">
		      <input type="text" name="ctid" value="<s:property value="ct.ctid" />" class="form-control" id="ctid" placeholder="ctid"  readonly = "readonly">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="ctname" class="col-sm-2 control-label">三级菜单名</label>
		    <div class="col-sm-10">
		      <input type="text" name="ctname" value="<s:property value="ct.ctname" />" class="form-control" id="ctname" placeholder="ctname">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="c" class="col-sm-2 control-label">上级菜单名</label>
		    <div class="col-sm-10">

		 	  <select name="csid" class="form-control" id="c">
	    		<s:iterator value="list" var="cs">
	    		<s:if test="#cs.csid == ct.categorySecond.csid" >

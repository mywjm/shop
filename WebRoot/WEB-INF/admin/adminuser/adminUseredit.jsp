        ...
        <div id="content" class="col-md-12">
         ...
         <!-- page header -->
          ...
          <div class="main">
    	   ...
    	   <!-- 管理员添加 -->
    	  <div >
		<form class="form-horizontal" action="${pageContext.request.contextPath }/admin_editAdmin.action" method="post" onsubmit="return check()">
		  <input type="hidden" name="auid" value="<s:property value="editUser.auid" />" />
		  <div class="form-group">
		    <label for="username" class="col-sm-2 control-label">管理员名</label>
		    <div class="col-sm-10">
		      <input type="text" name="username" value="<s:property value="editUser.username" />" class="form-control" id="username" placeholder="username">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="password" class="col-sm-2 control-label">密码</label>
		    <div class="col-sm-10">
		      <input type="text" name="password" value="<s:property value="editUser.password" />" class="form-control" id="password" placeholder="Password">
		    </div>
		  </div>
		  <s:if test="#session.existAdminUser != null">
		  <div class="form-group">

        ...
        <div id="content" class="col-md-12">
         ...
         <!-- page header -->
          ...
          <div class="main">
    	   ...
    	   <!-- 商品添加 -->
    	  <div >
		<form id="from" enctype="multipart/form-data"  class="form-horizontal" action="${pageContext.request.contextPath }/AdminProduct_add.action" method="post" onsubmit="return check()">
		  <div class="form-group">
		  <label for="pname" class="col-sm-2 control-label"> <i class="glyphicon glyphicon-asterisk" style="color: red"></i> 商品名称</label>
		    <div class="col-sm-10">
		      <input type="text" name="pname"  class="form-control" id="pname" placeholder="pname">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="shop_price" class="col-sm-2 control-label"><i class="glyphicon glyphicon-asterisk" style="color: red"></i>商品价</label>
		    <div class="col-sm-10">
		      <input type="text" name="shop_price"  class="form-control" id="shop_price" placeholder="shop_price">
		    </div>
		  </div>
		   <div class="form-group">
		    <label for="market_price" class="col-sm-2 control-label"><i class="glyphicon glyphicon-asterisk" style="color: red"></i>参考价</label>
		    <div class="col-sm-10">
		      <input type="text" name="market_price"  class="form-control" id="market_price" placeholder="market_price">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="pdate" class="col-sm-2 control-label"><i class="glyphicon glyphicon-asterisk" style="color: red"></i>商品上架时间</label>
		    <div class="col-sm-10">
		      <input type="date" name="pdate"  class="form-control" id="pdate" placeholder="pdate"><s:property value="p.pdate +2000" />
		    </div>
		  </div>
		 
		  <div class="form-group">
		    <label for="pdesc" class="col-sm-2 control-label"><i class="glyphicon glyphicon-asterisk" style="color: red"></i>商品描述</label>
		    <div class="col-sm-10">
		      <input type="text" name="pdesc"  class="form-control" id="pdesc" placeholder="pdesc">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="is_hot" class="col-sm-2 control-label"><i class="glyphicon glyphicon-asterisk" style="color: red"></i>是否热门</label>
		    <div class="col-sm-10">
		  ...
		  <div class="form-group">
		    <label for="c" class="col-sm-2 control-label"><i class="glyphicon glyphicon-asterisk" style="color: red"></i>商品所属分类</label>
		    <div class="col-sm-10">
		 	  <select name="ctid" class="form-control" id="c">
	    		<s:iterator value="list" var="ct">
		  ...
		  <div class="form-group">
		    <label for="picture" class="col-sm-2 control-label"><i class="glyphicon glyphicon-asterisk" style="color: red"></i>商品图片</label>
		    <div class="col-sm-10">
		 ...
		 <s:if test="#session.existAdminUser != null">
		  ...
		  <div class="form-group">
		    <div class="col-sm-offset-2 col-sm-10">
		      <a onclick="deleteA()" class="btn btn-default">添加</a>
		    </div>
		  </div>
		  </s:else>
		</form>

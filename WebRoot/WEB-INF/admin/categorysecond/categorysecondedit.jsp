        ...
        <div id="content" class="col-md-12">
         ...
         <!-- page header -->
          ...
          <div class="main">
    	   ...
    	   <!-- 二级修改 -->
    	  <div >
		<form class="form-horizontal" action="${pageContext.request.contextPath }/AdminCS_update.action" method="post" onsubmit="return check()">
		<%--  <input type="hidden" name="cid" value="<s:property value="categoryedit.cid" />" />  --%>
		  <div class="form-group">
		    <label for="csid" class="col-sm-2 control-label">ID</label>
		    <div class="col-sm-10">
		      <input type="text" name="csid" value="<s:property value="cs.csid" />" class="form-control" id="csid" placeholder="csid"  readonly = "readonly">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="csname" class="col-sm-2 control-label">二级菜单名</label>
		    <div class="col-sm-10">
		      <input type="text" name="csname" value="<s:property value="cs.csname" />" class="form-control" id="csname" placeholder="csname">
		    </div>
		  </div>
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		 	  ...
		 	  <select name="cid" class="form-control" id="c">
	    		<s:iterator value="list" var="c">
	    		<s:if test="#c.cid == cs.category.cid" >

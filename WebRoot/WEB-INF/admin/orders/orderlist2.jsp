...
<!--                   <li>
    ...
    <!-- Page content -->
        <div id="content" class="col-md-12">
         ...
         <!-- page header -->
          <div class="pageheader">
            ...
            <h2><i class="fa fa-tachometer"></i> 订单管理
		...
		<s:iterator var="order" value="pageBean.list" status="s" >
		<table class="table table-bordered table-hover " style="text-align: center;">
			...
			<s:iterator value="#order.orderItems" var="item" status="status">
			<tr>
				<td><s:property value="#status.count"/></td>
				<td><s:property value="#order.ordertime" /></td>
				<td ><a target="_blank" href="${pageContext.request.contextPath }/<s:property value="#item.product.image" />"><img src="<s:property value="#item.product.image" />" alt="<s:property value="#item.product.pname" />" style = "width: 100px; height: 100px;" /></a></td>
				<td style="overflow: auto;"><s:property value="#item.product.pname"/></td>
				<td>￥<s:property value="#item.product.shop_price"/>元</td>
				<td><s:property value="#item.count"/></td>
				<td>￥<s:property value="#item.subtotal"/>元</td>
				
			</tr>

			</s:iterator>
				<tr>
				<td>操作</td><td>--</td><td>--</td><td>--</td><td>--</td><td>--</td>
				<s:if test="#session.existAdminUser != null">
				<td>
					...
					<a href="${pageContext.request.contextPath }/AdminOrder_send.action?oid=<s:property value="#order.oid" /> " onclick="onclickB()">发货</a>
					</s:if>
			...
			<tr>
				<td>总计</td><td>--</td><td>--</td><td>--</td><td>--</td><td>--</td><td>￥<s:property value="#order.total" />元</td>
			</tr>
                    ...
                    <div class="product-pagination text-center">
                        <nav>
                          <ul class="pagination  pagination-lg">
                            <li>
                              <a href="${pageContext.request.contextPath}/AdminOrder_findByState.action?state=2&page=1" aria-label="first">
                                <span aria-hidden="true">&laquo;</span>
                              </a>
                            </li>
                            <s:if test="pageBean.page>1">
                            <li>
                              <a href="${pageContext.request.contextPath}/AdminOrder_findByState.action?state=2&page=<s:property value="pageBean.page-1" />" aria-label="Previous">
                            ...
                            <li>
                             ...
                             <s:if test="pageBean.totalPage >= 5">
                             	<s:if test="pageBean.page >2 " >
	                           	 <li><a href="${pageContext.request.contextPath}/AdminOrder_findByState.action?state=2&page=<s:property value="pageBean.page-2" />"><s:property value="pageBean.page-2" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminOrder_findByState.action?state=2&page=<s:property value="pageBean.page-1" />"><s:property value="pageBean.page-1" /></a></li>
	                           	 <li class="active"><a href="${pageContext.request.contextPath}/AdminOrder_findByState.action?state=2&page=<s:property value="pageBean.page" />" ><s:property value="pageBean.page" /></a></li>
	                           	 ...
	                           	 <li><a href="${pageContext.request.contextPath}/AdminOrder_findByState.action?state=2&page=<s:property value="pageBean.page+1" />"><s:property value="pageBean.page+1" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminOrder_findByState.action?state=2&page=<s:property value="pageBean.page+2" />"><s:property value="pageBean.page+2" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminOrder_findByState.action?state=2&page=<s:property value="pageBean.page+3" />"><s:property value="pageBean.page+3" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminOrder_findByState.action?state=2&page=<s:property value="pageBean.page+4" />"><s:property value="pageBean.page+4" /></a></li>
                           	 	</s:if>
                           	 	<s:if test="pageBean.page==2" >
                           	 	 <li><a href="${pageContext.request.contextPath}/AdminOrder_findByState.action?state=2&page=<s:property value="pageBean.page-1" />"><s:property value="pageBean.page-1" /></a></li>
                           	 	 <li class="active"><a href="${pageContext.request.contextPath}/AdminOrder_findByState.action?state=2&page=<s:property value="pageBean.page" />" ><s:property value="pageBean.page" /></a></li>
                            ...
                            <li>
                              <a href="${pageContext.request.contextPath}/AdminOrder_findByState.action?state=2&page=<s:property value="pageBean.page+1" />" aria-label="Next">
                            ...
                            <li>
                              <a href="${pageContext.request.contextPath}/AdminOrder_findByState.action?state=2&page=<s:property value="pageBean.totalPage" />" aria-label="last">

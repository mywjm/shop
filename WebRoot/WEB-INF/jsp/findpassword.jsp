   ...
   <%@include file="top.jsp" %>
  	<div style="background-color: #EEFFBB;">
   		<div style="margin: 0 50px;padding:50px 0; background-color: #DDDDDD; ">
			<form class="form-horizontal" action="${pageContext.request.contextPath }/user_sendEmailfindpassword.action" method="post">
			  <div class="form-group">
			    <label for="email" class="col-sm-2 control-label">注册的邮箱</label>
			    <div class="col-sm-6">

      ...
      <!-- Page content -->
        <div id="content" class="col-md-12">
         ...
         <!-- page header -->
          <div class="pageheader">
            ...
            <h2><i class="fa fa-tachometer"></i> 所有用户
		...
		<table class="table table-bordered table-hover " style="text-align: center;">
			...
			<tr>
				...
				<td>
				<s:if test="#session.existAdminUser != null">
				<a href="${ pageContext.request.contextPath }/adminUser_redefriend.action?uid=<s:property value="#u.uid" />" onclick="onclickC()">恢复</a>
				</s:if>
				<s:else>
				<a href="#" onclick="deleteA()">恢复</a>
				</s:else>
				</td>

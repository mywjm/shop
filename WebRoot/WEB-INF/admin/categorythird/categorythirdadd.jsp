        ...
        <div id="content" class="col-md-12">
         ...
         <!-- page header -->
          ...
          <div class="main">
    	   ...
    	   <!-- 管理员添加 -->
    	  <div >
		<form class="form-horizontal" action="${pageContext.request.contextPath }/AdminCT_add.action" method="post" onsubmit="return check()">
	
		  <div class="form-group">
		    <label for="ctname" class="col-sm-2 control-label">三级菜单名</label>
		    <div class="col-sm-10">
		      <input type="text" name="ctname" value="" class="form-control" id="ctname" placeholder="ctname">
		    </div>
		  </div>
		 <div class="form-group">

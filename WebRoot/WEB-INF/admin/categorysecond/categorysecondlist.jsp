    ...
    <!-- Page content -->
        <div id="content" class="col-md-12">
         ...
         <!-- page header -->
          <div class="pageheader">
            ...
            <h2><i class="fa fa-tachometer"></i> 二级菜单管理
		...
		<table class="table table-bordered table-hover " style="text-align: center;">
			<tr >
				...
				<th style="text-align: center;">二级菜单名</th>
			...
			<tr>
				...
				<td><s:property value="#cs.category.cname"/></td>
				<td>
				<s:if test="#session.existAdminUser != null">
				...
				<td>
				<s:if test="#session.existAdminUser != null">
				<a href="${ pageContext.request.contextPath }/AdminCS_edit.action?csid=<s:property value="#cs.csid" />" onclick="onclickA()">修改</a>
				</s:if>
				<s:else>
                    ...
                    <div class="product-pagination text-center">
                        <nav>
                          <ul class="pagination  pagination-lg">
                            <li>
                              <a href="${pageContext.request.contextPath}/AdminCS_findAll.action?page=1" aria-label="first">
                                <span aria-hidden="true">&laquo;</span>
                              </a>
                            </li>
                            <s:if test="pageBean.page>1">
                            <li>
                              <a href="${pageContext.request.contextPath}/AdminCS_findAll.action?page=<s:property value="pageBean.page-1" />" aria-label="Previous">
                            ...
                            <li>
                             ...
                             <s:if test="pageBean.totalPage >= 5">
                             	<s:if test="pageBean.page >2 " >
	                           	 <li><a href="${pageContext.request.contextPath}/AdminCS_findAll.action?page=<s:property value="pageBean.page-2" />"><s:property value="pageBean.page-2" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminCS_findAll.action?page=<s:property value="pageBean.page-1" />"><s:property value="pageBean.page-1" /></a></li>
	                           	 <li class="active"><a href="${pageContext.request.contextPath}/AdminCS_findAll.action?page=<s:property value="pageBean.page" />" ><s:property value="pageBean.page" /></a></li>
	                           	 ...
	                           	 <li><a href="${pageContext.request.contextPath}/AdminCS_findAll.action?page=<s:property value="pageBean.page+1" />"><s:property value="pageBean.page+1" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminCS_findAll.action?page=<s:property value="pageBean.page+2" />"><s:property value="pageBean.page+2" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminCS_findAll.action?page=<s:property value="pageBean.page+3" />"><s:property value="pageBean.page+3" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminCS_findAll.action?page=<s:property value="pageBean.page+4" />"><s:property value="pageBean.page+4" /></a></li>
                           	 	</s:if>
                           	 	<s:if test="pageBean.page==2" >
                           	 	 <li><a href="${pageContext.request.contextPath}/AdminCS_findAll.action?page=<s:property value="pageBean.page-1" />"><s:property value="pageBean.page-1" /></a></li>
                           	 	 <li class="active"><a href="${pageContext.request.contextPath}/AdminCS_findAll.action?page=<s:property value="pageBean.page" />" ><s:property value="pageBean.page" /></a></li>
                            ...
                            <li>
                              <a href="${pageContext.request.contextPath}/AdminCS_findAll.action?page=<s:property value="pageBean.page+1" />" aria-label="Next">
                            ...
                            <li>
                              <a href="${pageContext.request.contextPath}/AdminCS_findAll.action?page=<s:property value="pageBean.totalPage" />" aria-label="last">

    ...
    <!-- Page content -->
		...
		<table class="table table-bordered table-hover " style="text-align: center;">
			<tr >
				...
				<th style="text-align: center;">一级菜单名</th>
			...
			<tr>
				...
				<td>
				<s:if test="#session.existAdminUser != null">
				<a href="${ pageContext.request.contextPath }/AdminCategory_edit.action?cid=<s:property value="#c.cid" />" onclick="onclickA()">修改</a>
				</s:if>
				<s:else>
                    ...
                    <div class="product-pagination text-center">
                        <nav>
                          <ul class="pagination  pagination-lg">
                            <li>
                              <a href="${pageContext.request.contextPath}/AdminCategory_findAll.action?page=1" aria-label="first">
                                <span aria-hidden="true">&laquo;</span>
                              </a>
                            </li>
                            <s:if test="pageBean.page>1">
                            <li>
                              <a href="${pageContext.request.contextPath}/AdminCategory_findAll.action?page=<s:property value="pageBean.page-1" />" aria-label="Previous">
                            ...
                            <li>
                             ...
                             <s:if test="pageBean.totalPage >= 5">
                             	<s:if test="pageBean.page >2 " >
	                           	 <li><a href="${pageContext.request.contextPath}/AdminCategory_findAll.action?page=<s:property value="pageBean.page-2" />"><s:property value="pageBean.page-2" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminCategory_findAll.action?page=<s:property value="pageBean.page-1" />"><s:property value="pageBean.page-1" /></a></li>
	                           	 <li class="active"><a href="${pageContext.request.contextPath}/AdminCategory_findAll.action?page=<s:property value="pageBean.page" />" ><s:property value="pageBean.page" /></a></li>
	                           	 ...
	                           	 <li><a href="${pageContext.request.contextPath}/AdminCategory_findAll.action?page=<s:property value="pageBean.page+1" />"><s:property value="pageBean.page+1" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminCategory_findAll.action?page=<s:property value="pageBean.page+2" />"><s:property value="pageBean.page+2" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminCategory_findAll.action?page=<s:property value="pageBean.page+3" />"><s:property value="pageBean.page+3" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/AdminCategory_findAll.action?page=<s:property value="pageBean.page+4" />"><s:property value="pageBean.page+4" /></a></li>
                           	 	</s:if>
                           	 	<s:if test="pageBean.page==2" >
                           	 	 <li><a href="${pageContext.request.contextPath}/AdminCategory_findAll.action?page=<s:property value="pageBean.page-1" />"><s:property value="pageBean.page-1" /></a></li>
                           	 	 <li class="active"><a href="${pageContext.request.contextPath}/AdminCategory_findAll.action?page=<s:property value="pageBean.page" />" ><s:property value="pageBean.page" /></a></li>
                            ...
                            <li>
                              <a href="${pageContext.request.contextPath}/AdminCategory_findAll.action?page=<s:property value="pageBean.page+1" />" aria-label="Next">
                            ...
                            <li>
                              <a href="${pageContext.request.contextPath}/AdminCategory_findAll.action?page=<s:property value="pageBean.totalPage" />" aria-label="last">

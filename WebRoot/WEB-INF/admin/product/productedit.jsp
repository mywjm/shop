...
<!--                   <li>
    ...
    <!-- Page content -->
        <div id="content" class="col-md-12">
         ...
         <!-- page header -->
          ...
          <div class="main">
    	   ...
    	   <!-- 修改 -->
    	  <div >
		<form id="from" class="form-horizontal" action="${pageContext.request.contextPath }/AdminProduct_update.action" method="post" onsubmit="return check()">
		  <div class="form-group">
		    <label for="pid" class="col-sm-2 control-label">ID</label>
		    <div class="col-sm-10">
		      <input type="text" name="pid" value="<s:property value="p.pid" />" class="form-control" id="pid" placeholder="pid"  readonly = "readonly">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="pname" class="col-sm-2 control-label">商品名称</label>
		    <div class="col-sm-10">
		      <input type="text" name="pname" value="<s:property value="p.pname" />" class="form-control" id="pname" placeholder="pname">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="shop_price" class="col-sm-2 control-label">商品价</label>
		    <div class="col-sm-10">
		      <input type="text" name="shop_price" value="<s:property value="p.shop_price" />" class="form-control" id="shop_price" placeholder="shop_price">
		    </div>
		  </div>
		   <div class="form-group">
		    <label for="market_price" class="col-sm-2 control-label">参考价</label>
		    <div class="col-sm-10">
		      <input type="text" name="market_price" value="<s:property value="p.market_price" />" class="form-control" id="market_price" placeholder="market_price">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="pdate" class="col-sm-2 control-label">商品上架时间</label>
		    <div class="col-sm-10">
		      <input type="date" name="pdate" value="<s:property value="p.pdate" />" class="form-control" id="pdate" placeholder="pdate"><s:property value="p.pdate +2000" />
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" name="pdesc" value="<s:property value="p.pdesc" />" class="form-control" id="pdesc" placeholder="pdesc">
		    </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		    <label for="c" class="col-sm-2 control-label">商品所属分类</label>
		    <div class="col-sm-10">

		 	  <select name="ctid" class="form-control" id="c">
	    		<s:iterator value="list" var="ct">
	    		<s:if test="#ct.ctid == p.categoryThird.ctid" >
	    		<option value="<s:property value="#ct.ctid" />" selected="selected"><s:property value="#ct.ctname" /></option>
	    		</s:if> 
 	...
 	<div>
 		<form id="form1" class="form-horizontal" enctype="multipart/form-data" action="${pageContext.request.contextPath }/AdminProduct_upload.action" method="post" >
		  ...
		  <div class="form-group">
		    <div class="col-sm-offset-2 col-sm-10">
		      <a type="submit" class="btn btn-default" onclick="update()">修改图片</a>
		    </div>
		  </div>
		  </s:if>
		  <s:else>

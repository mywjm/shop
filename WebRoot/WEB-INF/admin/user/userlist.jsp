      ...
      <!-- Page content -->
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-tachometer"></i> 用户管理
		...
		<table class="table table-bordered table-hover " style="text-align: center;">
			...
			<tr>
				...
				<td>
				<s:if test="#session.existAdminUser != null">
				<a href="${ pageContext.request.contextPath }/adminUser_delete.action?uid=<s:property value="#u.uid" />" onclick="onclickB()">删除</a>
				</s:if>
				<s:else>
				...
				<td>
				<s:if test="#session.existAdminUser != null">
				<a href="${ pageContext.request.contextPath }/adminUser_defriend.action?uid=<s:property value="#u.uid" />" onclick="onclickC()">拉黑</a>
				</s:if>
				<s:else>
				<a href="#" onclick="deleteA()">拉黑</a>
				</s:else>
				</td>
                    ...
                    <div class="product-pagination text-center">
                        <nav>
                          <ul class="pagination  pagination-lg">
                            <li>
                              <a href="${pageContext.request.contextPath}/adminUser_findAll.action?page=1" aria-label="first">
                                <span aria-hidden="true">&laquo;</span>
                              </a>
                            </li>
                            <s:if test="pageBean.page>1">
                            <li>
                              <a href="${pageContext.request.contextPath}/adminUser_findAll.action?page=<s:property value="pageBean.page-1" />" aria-label="Previous">
                            ...
                            <li>
                             ...
                             <s:if test="pageBean.totalPage >= 5">
                             	<s:if test="pageBean.page >2 " >
	                           	 <li><a href="${pageContext.request.contextPath}/adminUser_findAll.action?page=<s:property value="pageBean.page-2" />"><s:property value="pageBean.page-2" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/adminUser_findAll.action?page=<s:property value="pageBean.page-1" />"><s:property value="pageBean.page-1" /></a></li>
	                           	 <li class="active"><a href="${pageContext.request.contextPath}/adminUser_findAll.action?page=<s:property value="pageBean.page" />" ><s:property value="pageBean.page" /></a></li>
	                           	 ...
	                           	 <li><a href="${pageContext.request.contextPath}/adminUser_findAll.action?page=<s:property value="pageBean.page+1" />"><s:property value="pageBean.page+1" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/adminUser_findAll.action?page=<s:property value="pageBean.page+2" />"><s:property value="pageBean.page+2" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/adminUser_findAll.action?page=<s:property value="pageBean.page+3" />"><s:property value="pageBean.page+3" /></a></li>
	                           	 <li><a href="${pageContext.request.contextPath}/adminUser_findAll.action?page=<s:property value="pageBean.page+4" />"><s:property value="pageBean.page+4" /></a></li>
                           	 	</s:if>
                           	 	<s:if test="pageBean.page==2" >
                           	 	 <li><a href="${pageContext.request.contextPath}/adminUser_findAll.action?page=<s:property value="pageBean.page-1" />"><s:property value="pageBean.page-1" /></a></li>
                           	 	 <li class="active"><a href="${pageContext.request.contextPath}/adminUser_findAll.action?page=<s:property value="pageBean.page" />" ><s:property value="pageBean.page" /></a></li>
                            ...
                            <li>
                              <a href="${pageContext.request.contextPath}/adminUser_findAll.action?page=<s:property value="pageBean.page+1" />" aria-label="Next">
                            ...
                            <li>
                              <a href="${pageContext.request.contextPath}/adminUser_findAll.action?page=<s:property value="pageBean.totalPage" />" aria-label="last">

    ...
    <div class="container-fluid msg">
    	<div class="row">
    		<div class="col-sm-offset-3 col-md-6"> 
  				<div>
  					<img alt="关于我们" src="${pageContext.request.contextPath }/img/about1.jpg">
  				</div>
    		</div>
    		<div class="col-sm-offset-3 col-md-6"> 
  				<div>
  					<img alt="关于我们" src="${pageContext.request.contextPath }/img/about2.jpg">
  				</div>
    		</div>
    		<div class="col-sm-offset-3 col-md-6"> 
  				<div>
  					<img alt="关于我们" src="${pageContext.request.contextPath }/img/about3.jpg">
  				</div>
    		</div>

...
<!-- login-form -->
 ...
 <div style="margin: 10px 250px 10px 50px; padding: 10px;">
 	<div class="row">
 	 <h1>修改收货地址</h1>
	<form class="form-horizontal" action="${pageContext.request.contextPath }/address_update.action" method="post">
  <div class="form-group">
    <label for="consignee" class="col-sm-2 control-label">收货人</label>
    <div class="col-sm-10">
      <input type="text" value="<s:property value="#session.update_address.consignee" />" name="consignee" class="form-control" id="consignee" placeholder="收货人">
    </div>
  </div>
  <div class="form-group">
    <label for="phone" class="col-sm-2 control-label">联系电话</label>
    <div class="col-sm-10">
      <input type="text" value="<s:property value="#session.update_address.phone" />" name="phone" class="form-control" id="phone" placeholder="电话">
    </div>
  </div>
 <div class="form-group">
    <label for="addr" class="col-sm-2 control-label">收货地址</label>
    <div class="col-sm-10">
      <input type="text" value="<s:property value="#session.update_address.addr" />" name="addr" class="form-control" id="addr" placeholder="地址">
    </div>
  </div>
  <div class="form-group">
